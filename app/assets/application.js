...
%o`, message, error2, detail);
  ...
  var autogrow_controller_default = class extends Controller {
    initialize() {
  ...
  var conversation_controller_default = class extends Controller {
  ...
  // app/javascript/controllers/media_tagging_controller.js
  var media_tagging_controller_default = class extends Controller {
  ...
  // app/javascript/controllers/misc_controller.js
  var misc_controller_default = class extends Controller {
    copyLink() {
  ...
  // app/javascript/controllers/scroller_controller.js
  ...
  var import_theme_controller = __toESM(require_theme_controller());
  ...
  var Tweet = class extends Controller {
    ...
    notTweet() {
      return /^\s*$/.test(this.content) || this.length < 1 || this.length > 1e4;
    }
    changeToWrite() {
  ...
  // app/javascript/controllers/index.js
  application.register("autogrow", autogrow_controller_default);
  application.register("conversation", conversation_controller_default);
  application.register("dropdown", dropdown_controller_default);
  application.register("media-tagging", media_tagging_controller_default);
  application.register("message", message_controller_default);
  application.register("misc", misc_controller_default);
  application.register("scroller", scroller_controller_default);
  application.register("search", search_controller_default);
  application.register("theme", import_theme_controller.default);
  application.register("turbo-modal", turbo_modal_controller_default);
  application.register("tweet", Tweet);
  ...
  var themeToggleIcon = document.querySelector(".theme-toggle");
